  ...
  return (
    <section id="about-section" className={styles.sectionContainer}>
      ...
      <p className={styles.introText}>
        ...
        negócio. Com apenas 8 anos de mercado mas com profissionais que dominam
        o mercado com mais de 15 anos de experiência trabalhando com pessoas,
        somos especialistas em conectar empresas inovadoras a profissionais que
        impulsionam o sucesso. Nossa abordagem única combina a precisão da
        tecnologia com a intuição humana, garantindo resultados excepcionais em
        tempo recorde.
      </p>
