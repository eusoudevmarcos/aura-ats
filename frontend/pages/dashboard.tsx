...
const DashboardPage: React.FC = () => {
  ...
  return (
    <div className="dashboardContainer"> {/* Classe global definida em globals.css */}
      {/* Sidebar */}
      <Sidebar
      ...
      <div className="mainContentArea"> {/* Classe global definida em globals.css */}
        {/* Header */}
        <Header toggleSidebar={toggleSidebar} />

        {/* Área de Conteúdo Dinâmico */}
        <main className="dashboardMainContent"> {/* Classe global definida em globals.css */}
